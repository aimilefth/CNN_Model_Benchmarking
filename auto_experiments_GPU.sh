...
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 1 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 2 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 4 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 8 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 16 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 32 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 64 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 128 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 256 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 1 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 2 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 4 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 8 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 16 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 32 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 64 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 128 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 256 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 1 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 2 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 4 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 8 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 16 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 32 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 64 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 128 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${INCEPTIONV4} -b 256 -t INT8

rm -rf ${INCEPTIONV4}_TensorRT_FP32_BATCH_1
rm -rf ${INCEPTIONV4}_TensorRT_FP32_BATCH_2
rm -rf ${INCEPTIONV4}_TensorRT_FP32_BATCH_4
rm -rf ${INCEPTIONV4}_TensorRT_FP32_BATCH_8
rm -rf ${INCEPTIONV4}_TensorRT_FP32_BATCH_16
rm -rf ${INCEPTIONV4}_TensorRT_FP32_BATCH_32
rm -rf ${INCEPTIONV4}_TensorRT_FP32_BATCH_64
rm -rf ${INCEPTIONV4}_TensorRT_FP32_BATCH_128
rm -rf ${INCEPTIONV4}_TensorRT_FP32_BATCH_256
rm -rf ${INCEPTIONV4}_TensorRT_FP16_BATCH_1
rm -rf ${INCEPTIONV4}_TensorRT_FP16_BATCH_2
rm -rf ${INCEPTIONV4}_TensorRT_FP16_BATCH_4
rm -rf ${INCEPTIONV4}_TensorRT_FP16_BATCH_8
rm -rf ${INCEPTIONV4}_TensorRT_FP16_BATCH_16
rm -rf ${INCEPTIONV4}_TensorRT_FP16_BATCH_32
rm -rf ${INCEPTIONV4}_TensorRT_FP16_BATCH_64
rm -rf ${INCEPTIONV4}_TensorRT_FP16_BATCH_128
rm -rf ${INCEPTIONV4}_TensorRT_FP16_BATCH_256
rm -rf ${INCEPTIONV4}_TensorRT_INT8_BATCH_1
rm -rf ${INCEPTIONV4}_TensorRT_INT8_BATCH_2
rm -rf ${INCEPTIONV4}_TensorRT_INT8_BATCH_4
rm -rf ${INCEPTIONV4}_TensorRT_INT8_BATCH_8
rm -rf ${INCEPTIONV4}_TensorRT_INT8_BATCH_16
rm -rf ${INCEPTIONV4}_TensorRT_INT8_BATCH_32
rm -rf ${INCEPTIONV4}_TensorRT_INT8_BATCH_64
rm -rf ${INCEPTIONV4}_TensorRT_INT8_BATCH_128
rm -rf ${INCEPTIONV4}_TensorRT_INT8_BATCH_256

python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 1 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 2 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 4 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 8 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 16 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 32 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 64 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 128 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 256 -t FP32
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 1 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 2 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 4 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 8 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 16 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 32 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 64 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 128 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 256 -t FP16
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 1 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 2 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 4 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 8 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 16 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 32 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 64 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 128 -t INT8
python3 -u GPU_Inference_TensorRT_v2_batch_auto.py -m ${RESNET152} -b 256 -t INT8

rm -rf ${RESNET152}_TensorRT_FP32_BATCH_1
rm -rf ${RESNET152}_TensorRT_FP32_BATCH_2
rm -rf ${RESNET152}_TensorRT_FP32_BATCH_4
rm -rf ${RESNET152}_TensorRT_FP32_BATCH_8
rm -rf ${RESNET152}_TensorRT_FP32_BATCH_16
rm -rf ${RESNET152}_TensorRT_FP32_BATCH_32
rm -rf ${RESNET152}_TensorRT_FP32_BATCH_64
rm -rf ${RESNET152}_TensorRT_FP32_BATCH_128
rm -rf ${RESNET152}_TensorRT_FP32_BATCH_256
rm -rf ${RESNET152}_TensorRT_FP16_BATCH_1
rm -rf ${RESNET152}_TensorRT_FP16_BATCH_2
rm -rf ${RESNET152}_TensorRT_FP16_BATCH_4
rm -rf ${RESNET152}_TensorRT_FP16_BATCH_8
rm -rf ${RESNET152}_TensorRT_FP16_BATCH_16
rm -rf ${RESNET152}_TensorRT_FP16_BATCH_32
rm -rf ${RESNET152}_TensorRT_FP16_BATCH_64
rm -rf ${RESNET152}_TensorRT_FP16_BATCH_128
rm -rf ${RESNET152}_TensorRT_FP16_BATCH_256
rm -rf ${RESNET152}_TensorRT_INT8_BATCH_1
rm -rf ${RESNET152}_TensorRT_INT8_BATCH_2
rm -rf ${RESNET152}_TensorRT_INT8_BATCH_4
rm -rf ${RESNET152}_TensorRT_INT8_BATCH_8
rm -rf ${RESNET152}_TensorRT_INT8_BATCH_16
rm -rf ${RESNET152}_TensorRT_INT8_BATCH_32
rm -rf ${RESNET152}_TensorRT_INT8_BATCH_64
rm -rf ${RESNET152}_TensorRT_INT8_BATCH_128
rm -rf ${RESNET152}_TensorRT_INT8_BATCH_256
