...
def insert_layer_nonseq(model, layer_regex, insert_layer_factory,
    ...
    return Model(inputs=model.inputs, outputs=model_outputs, name="resnet152_trick")
...
def evaluate(data_dir,batchsize,chkpt_dir,use_csv):
    ...
    if("ResNet50" in MODEL_NAME):
       ...
       model = insert_layer_nonseq(model=model, layer_regex="avg_pool", insert_layer_factory=Avg_pool_2_factory, position="replace")
       model.save("./temp1")
       model = keras.models.load_model("./temp1")
       model = insert_layer_nonseq(model=model, layer_regex="avg_pool_2", insert_layer_factory=Global_avg_pool_factory, position="after")
    model.compile(
