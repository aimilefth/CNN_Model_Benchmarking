...
GLOBALS = '-----------------------------------------'
MODEL_NAME = "LeNet5_Cifar10_48pct_0_84MF_func_relu"
VERBOSE = 1
ZIPFILE_NAME = 'cifar_test_1000.zip'    # The zip file name inside files folder 
IMAGES_CSV = "cifar_test_1000.csv" # The contained files in the zip
LABELS_CSV = "cifar_test_1000_labels.csv"
